      ...
      <div className="container">
        <div className="row">
          <div className="col-xs">
            ...
            <div>
              ...
              <button className="btn white">button white</button>
            </div>
            <div>
              <br/>
              <button className="btn radius">button radius</button>
              <button className="btn radius white">button radius white</button>
            </div>
            <div>
              <br/>
              <button className="btn round">button round</button>
              <button className="btn round white">button round white</button>
            </div>
            <div>
              <br/>
              <button className="btn big radius">button big radius</button>
              <button className="btn big radius white">button big radius white</button>
            </div>
            <div>
              <br/>
              <button className="btn btn-block">button btn-block</button>
              <button className="btn btn-block white">button btn-block white</button>
            </div>
            <div>
              <br/>
              <button className="btn white stroked">button white stroked</button>
              <button className="btn white stroked radius">button white stroked radius</button>
              <button className="btn white stroked round">button white stroked round</button>
            </div>
            <br/>
            <br/>
            <br/>
            ...
            <p>
              In publishing and graphic design, lorem ipsum (derived from Latin dolorem ipsum, translated as "pain
              itself")
              is a filler text commonly used to demonstrate the graphic elements of a document or visual presentation.
              Replacing meaningful content with placeholder text allows viewers to focus on graphic aspects such as
              font,
              typography, and page layout without being distracted by the content. It also reduces the need for the
              designer
              to come up with meaningful text, as they can instead use quickly-generated lorem ipsum.[citation needed]
            </p>
            <p>
              The lorem ipsum text is typically a scrambled section of De finibus bonorum et malorum, a 1st-century BC
              Latin
        ...
        <div className="row">
          <div className="col-xs">
            ...
            <p>By default "Spinner" look like this: <br/>Warning! Spinner need to wrap by tag with relative position,
              because it's centered by parent tag</p>
            ...
            <p>You can setting your spinner with props <b>radius</b> and <b>width</b>, and position by class <b>text-left,
              text-right, text-center (by default)</b></p>
            <div style={{position: 'relative'}}>
              <br/>
              <br/>
